...
public final class ActivityScanBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout scanActivity;

  @NonNull
  public final TextView textView;

  private ActivityScanBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView navView, @NonNull ConstraintLayout scanActivity,
  ...
  public static ActivityScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout scanActivity = (ConstraintLayout) rootView;
      ...
      return new ActivityScanBinding((ConstraintLayout) rootView, navView, scanActivity, textView);
    }
